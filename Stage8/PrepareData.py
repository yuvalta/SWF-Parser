...
cluster5=dict()
cluster6=dict()
mat = scipy.io.loadmat('ResidenceTimes.mat')
...
for j in df_.iterrows(): 
    if df_.loc[df_.index[i],'kmeans_cluster']==0:
        cluster0.setdefault("User"+str(i+1),(mat["User"+str(i+1)][0][0]).item())
    if df_.loc[df_.index[i],'kmeans_cluster']==1:
        cluster1.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    if df_.loc[df_.index[i],'kmeans_cluster']==2:
        cluster2.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    if df_.loc[df_.index[i],'kmeans_cluster']==3:
        cluster3.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    if df_.loc[df_.index[i],'kmeans_cluster']==4:
        cluster4.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    if df_.loc[df_.index[i],'kmeans_cluster']==5:
        cluster5.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    if df_.loc[df_.index[i],'kmeans_cluster']==6:
        cluster6.setdefault("User"+str(i+1),mat["User"+str(i+1)][0][0].item())
    i+=1
...
cluster5=dict(sorted(cluster0.items(), key=lambda item: item[1]))
cluster6=dict(sorted(cluster0.items(), key=lambda item: item[1]))
